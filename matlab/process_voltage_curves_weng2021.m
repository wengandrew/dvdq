function process_voltage_curves_weng2021()
    ...
    % Set paths
    input_path = 'C:/Users/wenga/Documents/fast-formation/data/2020-10-diagnostic-test-c20';
    output_path = 'outputs/weng2021/';
    output_filename = 'esoh_parameters_weng2021.csv';
    ...
    writetable(results_table, [output_path output_filename]);
