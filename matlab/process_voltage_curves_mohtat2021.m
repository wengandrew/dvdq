function process_voltage_curves_mohtat2021()
    % Process voltage curves from Peyman's dataset.

    set_default_plot_settings_manuscript();

    % Set paths
    input_path = 'C:/Users/wenga/Documents/expansion-peyman-2021/data/';
    output_path = 'outputs/mohtat2021/';
    output_filename = 'esoh_parameters_mohtat2021.csv';
