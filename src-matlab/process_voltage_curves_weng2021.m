function process_voltage_curves_weng2021()
    ...
    % Globals
    MAX_CYCLE_NUMBER = 500; % Don't process data past this point

    % Set paths
    input_path = 'data/weng2021-diagnostic-test-c20';
    output_path = 'data/metrics_weng2021.csv';
