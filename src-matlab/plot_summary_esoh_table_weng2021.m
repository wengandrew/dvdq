function plot_summary_esoh_table_weng2021()

    tbl = readtable('data/metrics_weng2021.csv');
...
function plot_helper_state_variables(plot_type, tbl)
    ...
    saveas(fh_summary, sprintf('metrics_weng2021_all_cells_%s_1.png', plot_type))
    saveas(fh_summary, sprintf('metrics_weng2021_all_cells_%s_1.fig', plot_type))
