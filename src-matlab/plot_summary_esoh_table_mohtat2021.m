function plot_summary_esoh_table_mohtat2021()

    tbl = readtable('data/metrics_mohtat2021.csv');
   
    % Get rid of high RMS data points
    RMSE_THRESHOLD_MV = 50;
